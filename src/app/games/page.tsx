    ...
    <div className="lg:pl-[354px] min-h-screen bg-[#faf8f5] bg-creased-paper py-10 sm:py-14 pr-4 sm:pr-8 lg:pr-12 pl-4 sm:pl-8 transition-all">
      <div className="w-full max-w-[1680px] mx-auto">
        ...
        <motion.div
          ...
          className="card-retro bg-[#f4eee3] p-4 sm:p-5 border-[2.5px] border-[#0c0f14] shadow-[4px_4px_0px_#0c0f14] mb-10 sm:mb-12 flex flex-col md:flex-row items-center justify-between gap-4"
        >
          {/* Pill Search Input */}
        ...
        {filteredGames.length === 0 ? (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="text-center py-16 card-retro bg-white p-8 border-[2.5px] border-[#0c0f14] shadow-[4px_4px_0px_#0c0f14]"
          >
          ...
          /* High-Fidelity 3/4-Column Physical Archival Grid with Framer Motion */
          <motion.div layout className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-6 sm:gap-7 lg:gap-8">
              ...
              {filteredGames.map((game, idx) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`card-retro ${paperBg} p-5 sm:p-6 border-[2.5px] border-[#0c0f14] shadow-[4px_4px_0px_#0c0f14] hover:shadow-[7px_7px_0px_#0c0f14] flex flex-col justify-between group relative ${
                  ...
                  >
                    ...
                    <div className="pt-3.5 border-t-2 border-dashed border-[#0c0f14]/20 flex items-center justify-between">
                      <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
                        <Link
                          href={`/games/${game.id}`}
                          className="btn-retro px-4 py-2 bg-[#0c0f14] hover:bg-zinc-800 text-[#fef08a] font-display text-xs font-black uppercase tracking-wider rounded-lg shadow-[2px_2px_0px_#0c0f14] flex items-center gap-1.5 group/btn"
                        >
          ...
          <motion.div layout className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-7">
            <AnimatePresence mode="popLayout">
              {filteredGames.map((game) => (
                <motion.div
                  ...
                  className="card-retro bg-white p-5 border-[2.5px] border-[#0c0f14] shadow-[4px_4px_0px_#0c0f14] hover:shadow-[6px_6px_0px_#0c0f14] flex flex-col justify-between relative"
                >
                  <div className="pushpin-red" />
