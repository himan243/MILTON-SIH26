  ...
  return (
    <div className="lg:pl-[354px] min-h-screen bg-[#faf8f5] bg-creased-paper py-10 sm:py-14 px-4 sm:px-6 lg:px-10 transition-all">
      <div className="max-w-[1320px] mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1 bg-[#fef08a] border-2 border-black rounded-full font-display text-xs uppercase tracking-wider shadow-retro-sm mb-3">
        ...
        >
          ...
          <div className="relative w-full md:w-96">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-white border-2 border-black rounded-xl text-xs font-bold text-[#0c0f14] placeholder-zinc-500 outline-none shadow-retro-sm focus:ring-2 focus:ring-[#d97706]"
            />
          </div>

          {/* Category Badges with Spring Hover */}
        ...
        {/* Crafts Animated Grid with Framer Motion Layout */}
          ...
          <AnimatePresence mode="popLayout">
            {filteredCrafts.map((craft, idx) => (
              <motion.div
                ...
                className={`card-retro bg-white p-5 sm:p-6 border-[2.5px] border-[#0c0f14] shadow-retro-md hover:shadow-retro-lg grid grid-cols-1 sm:grid-cols-12 gap-5 group relative ${
                  idx % 2 === 0 ? 'tilt-subtle-left' : 'tilt-subtle-right'
                }`}
              >
                {idx % 3 === 0 && <div className="pushpin-red" />}
                {idx % 3 === 1 && <div className="washi-tape-mint" />}
                {idx % 3 === 2 && <div className="washi-tape-coral" />}
                ...
                <div className="sm:col-span-5 relative aspect-square sm:aspect-auto rounded-xl overflow-hidden border-2 border-black bg-zinc-200 shadow-retro-sm">
                  ...
                  />
                  <span className="absolute top-2 left-2 px-2 py-0.5 bg-white/95 border border-black rounded-md font-display text-[10px] uppercase shadow-retro-sm">
                    {craft.category}
                  </span>
                </div>
                ...
                <div className="sm:col-span-7 flex flex-col justify-between space-y-3">
                  <div>
                    <div className="flex items-center justify-between mb-1 pr-6">
                      ...
                      <span className="rubber-stamp rubber-stamp-green text-[9px] py-0.5 animate-stamp-slam">
                  ...
                  <div className="pt-3 border-t border-black/10 flex items-center justify-between">
                    <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
                      <Link
                        ...
                        className="btn-retro px-3 py-1.5 bg-[#0c0f14] hover:bg-zinc-800 text-[#fef08a] font-display text-xs font-black uppercase tracking-wider rounded-lg shadow-retro-sm flex items-center gap-1 group/btn"
                      >
